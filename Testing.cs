...
";
    ...
    private static void TestX86_16Instructions()
    {
        ...
        AssertArrayEqual(new byte[] { 0xCB }, retfCode, "RETF instruction encoding");
        ...
        AssertArrayEqual(new byte[] { 0x55 }, pushCode, "PUSH bp encoding");
        
        // Test POP bp (16-bit)
        var popCode = Badger.Architectures.x86_16.Assembler.Assemble("pop bp");
        AssertArrayEqual(new byte[] { 0x5D }, popCode, "POP bp encoding");
        
        // Test PUSH ax
        var pushAxCode = Badger.Architectures.x86_16.Assembler.Assemble("push ax");
        AssertArrayEqual(new byte[] { 0x50 }, pushAxCode, "PUSH ax encoding");
        
        // Test POP ax
        var popAxCode = Badger.Architectures.x86_16.Assembler.Assemble("pop ax");
        AssertArrayEqual(new byte[] { 0x58 }, popAxCode, "POP ax encoding");
        ...
        Assert(movImmCode.Length == 3 && movImmCode[0] == 0xB8 && 
        ...
        AssertArrayEqual(new byte[] { 0x83, 0xC4, 0x02 }, addImm8Code, 
        ...
        Assert(addImm16Code.Length == 4 && addImm16Code[0] == 0x81 && 
               addImm16Code[1] == 0xC4,
        ...
        AssertArrayEqual(new byte[] { 0x83, 0xEC, 0x08 }, subImm8Code,
        ...
        Assert(subImm16Code.Length == 4 && subImm16Code[0] == 0x81 && 
               subImm16Code[1] == 0xEC,
        ...
        Assert(callCode.Length == 3 && callCode[0] == 0xE8,
        ...
        var prologueCode = Badger.Architectures.x86_16.Assembler.Assemble(@"
            ...
            sub sp, 10
        ");
        Assert(prologueCode.Length == 6, "16-bit function prologue",
        ...
        var epilogueCode = Badger.Architectures.x86_16.Assembler.Assemble(@"
            ...
            ret
        ");
        Assert(epilogueCode.Length == 4, "16-bit function epilogue",
